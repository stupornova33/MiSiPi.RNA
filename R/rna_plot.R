...
rna_plot <- function(path_to_RNAfold, path_to_RNAplot, wkdir, pos_df, colors, chrom_name, most_abundant_start, most_abundant_stop, strand) {
  ...
  filename <- paste0(chrom_name, "-", most_abundant_start, "_", most_abundant_stop, "_", "ss.ps")
