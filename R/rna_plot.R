...
.rna_plot <- function(path_to_RNAfold, path_to_RNAplot, wkdir, pos_df, colors, chrom_name, reg_start, reg_stop, most_abundant_start, most_abundant_stop, strand) {
  ...
  filename <- paste0(chrom_name, "-", most_abundant_start - 1, "_", most_abundant_stop - 1, "_", "ss.ps")
  ...
  new_filename <- paste0(chrom_name, "-", reg_start - 1, "_", reg_stop - 1, "_", strand, "_", "ss.ps")
