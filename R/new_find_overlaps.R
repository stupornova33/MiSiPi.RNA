...
# Can likely remove as it is identical to .find_overlaps() in every respect
# Except for the else {} block. It wasn't being called anywhere that
# only passed in a single data.frame, however, so it seems unneeded
