...
get_weighted_read_dist <- function(forward_dt, reverse_dt) {
  ...
  widths <- c(rep(16, times = 4), rep(17, times = 4), rep(18, times=4), rep(19, times=4),rep(20, times=4),rep(21, times=4),rep(22, times=4),rep(23, times=4),rep(24, times=4),rep(25, times=4),
              rep(26, times=4),rep(27, times=4),rep(28, times=4),rep(29, times=4),rep(30, times=4))
  first <- c("A", "G", "C", "T")
